...
async function cleanPartials() {
  await del(["dist/partials"]);
}
...
function watchFiles(done) {
  ...
  watch(paths.html.src, series(html, cleanPartials));
...
export { clean, cleanPartials, styles, scripts, html, images, icons, fonts, watchFiles as watch, build };

export default series(build, watchFiles);

// Тепер partials будуть видалятися з dist після збірки 🚀
